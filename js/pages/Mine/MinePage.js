...
export default class MinePage extends BaseComponent {
  ...
  createSettingItem(tag,icon,text){
    return ViewUtils.createSettingItem(() => this.onClick(tag),icon,text,this.state.theme.styles.tabBarSelectedIcon,null)
  ...
  render() {
    return (
        <View style={GlobalStyles.listViewContainerStyle}>
          {/*导航栏*/}
          <NavigationBar
              title={'我的'}
          ...
          <ScrollView>
            ...
            {/*自定义主题*/}
            <View style={GlobalStyles.cellBottomLineStyle}/>
            {this.createSettingItem(MORE_MENU.Custom_Theme,require('../../../res/images/ic_custom_theme.png'),'自定义主题')}
            <View style={GlobalStyles.cellBottomLineStyle}/>
